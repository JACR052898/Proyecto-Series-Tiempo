...
De acuerdo con las métricas de evaluación, la mejor predicción la realiza el modelo de JORDAN, pues presenta un valor de RMSE de 0.005252 y MAE de 0.0045 y al ser más bajos que en el modelo de ELMAN, indican que el modelo tiene un rendimiento mejor.